            ...
            var leaderboard = {
                ...
                setScoreAsync: function(score, extraData) {
                    var leaderboardEntry = Utils.createLeaderboardEntry(
                        score, 
                        3, 
                        {name:'Player 1', photo: '/assets/mock/profile.jpg', id: 123456789}, 
                        extraData
                    );
                ...
                getEntriesAsync: function() {
                    var entries = [
                        ...
                        Utils.createLeaderboardEntry(
                            43, 
                            2, 
                            {name:'Player 2', photo: '/assets/mock/friend1.png', id: 43}, 
                            null
                        ),
                        Utils.createLeaderboardEntry(
                            44, 
                            1, 
                            {name:'Player 3', photo: '/assets/mock/friend2.png', id: 44}, 
                            null
                        )
                    ];
